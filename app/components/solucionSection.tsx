...
// Memoized SolutionCard component
const SolutionCard: FC<SolutionCardProps> = memo(({ solution, isActive, onCardClick }) => {
  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        <h2 className="text-xl font-semibold text-gray-900 mb-4">{solution.title}</h2>
...
SolutionCard.displayName = 'SolutionCard'; // Helpful for debugging in React DevTools
...
const SolucionesEmpresa: FC = () => {
  ...
  const headerContent = useMemo<HeaderContent>(() => ({
    ...
    description:
      'Cada solución tiene sus características que permitirá generar una gran cantidad de información, la cual se puede ver en tiempo real en la plataforma y poder generar reportes específicos que permita ver el crecimiento de la empresa.',
  }), []);
...
export default SolucionesEmpresa;